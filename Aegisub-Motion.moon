...
export script_version     = "1.0.0-beta3"
...
initializeInterface = ->
	...
	interface = {
		main: {
			...
			absPos:    { class: "checkbox", x: 4, y: 5,  width: 2,  height: 1, config: true, label: "&Absolute",     value: false, hint: "Set position to exactly that of the tracking data with no processing." }
